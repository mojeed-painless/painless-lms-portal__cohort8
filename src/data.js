...
export const topics = [
    ...
    //         {name: 'Browser User Interaction', path: '/js-browser-user-interaction'},
    ...
    //         {name: 'If Statement', path: '/js-if-statement'},
    //         {name: 'Elseif Statement', path: '/js-elseif-statement'},
    //         {name: 'Switch Statement', path: '/js-switch-statement'},
    //         {name: 'OR Operator', path: '/js-or-operator'},
    //         {name: 'AND Operator', path: '/js-and-operator'},
    //         {name: 'NOT Operator', path: '/js-not-operator'},
    //         {name: 'Nullish Operator', path: '/js-nullish-operator'},
    //         {name: 'While Loop', path: '/js-while-loop'},
    //         {name: 'For Loop', path: '/js-for-loop'},
    //         {name: 'Breaking Loop', path: '/js-breaking-loop'},
    //         {name: 'Continue Loop', path: '/js-continue-loop'},
    //         {name: 'Function Declaration', path: '/js-function-declaration'},
    //         {name: 'Local & Global Variables', path: '/js-local-global-variables'},
    //         {name: 'Function Parameters', path: '/js-function-parameters'},
    //         {name: 'Return statement in Function', path: '/js-return-function'},
    //         {name: 'Naming Functions', path: '/js-naming-functions'},
    //         {name: 'Function Expression', path: '/js-function-expression'},
    //         {name: 'Arrow Function', path: '/js-arrow-function'},
    //         {name: 'Objects', path: '/js-objects'},
    //         {name: 'Dot Notation', path: '/js-dot-notation'},
    //         {name: 'Square-bracket Notation', path: '/js-square-bracket-notation'},
    //         {name: 'Test for Property Existence', path: '/js-property-existence'},
    //         {name: 'Object Loops', path: '/js-object-loops'},
    //         {name: 'Object Referencing', path: '/js-object-referencing'},
    //         {name: 'Cloning Object', path: '/js-cloning-object'},
    //         {name: 'Object Methods', path: '/js-object-methods'},
    //         {name: 'Array Declaration', path: '/js-array-declaration'},
    //         {name: 'Array Indexing', path: '/js-array-indexing'},
    //         {name: 'Array Length', path: '/js-array-length'},
    //         {name: 'Multiple Typed Array', path: '/js-multiple-typed-array'},
    //         {name: 'Array Loops', path: '/js-array-loops'},
    //         {name: 'Pop & Shift Methods', path: '/js-pop-shift-methods'},
    //         {name: 'Slice Method', path: '/js-slice-method'},
    //         {name: 'Splice Method', path: '/js-splice-method'},
    //     ]
    // },
]
